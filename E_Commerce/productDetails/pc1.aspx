<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="pc1.aspx.cs" Inherits="E_Commerce.productDetails.pc1" %>
    ...
    <div class="container mt-5 product-container">
        <div class="row">
            <div class="col-md-4 d-flex ">
                <img src="../imgs/PCs/pc1/pc 1.jpg" class="img-fluid product-image" alt="zord pc" />
            </div>
            <div class="col-md-8 float-right">
                <h1 class="text-primary" id="productName" runat="server">PC BUILD BY ZORD</h1>
                <p class="text-muted"><strong>Brand:</strong> ZORD</p>
                ...
                <p class="text-muted" id="graphicsCardLabel" runat="server"><strong>Graphics Card:</strong> GTX 1660 SUPER</p>
                <p class="text-muted display-6" id="priceLabel" runat="server"><strong>Price:</strong> $699.99</p>
